...
def create_research_task(agent, participants, context):
    return Task(
...
def create_industry_analysis_task(agent, participants, context):
    return Task(
        description=dedent(f"""\
...
def create_meeting_strategy_task(agent, context, objective):
    return Task(
        description=dedent(f"""\
...
def create_briefing_task(agent, context, objective):
    return Task(
        description=dedent(f"""\
            ...
            the meeting. Ensure the briefing is easy to digest and equips the
